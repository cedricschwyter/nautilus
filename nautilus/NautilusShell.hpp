...
namespace nautilus {
    ...
    public:
        ...
        /**
         * Contains the loop for the context
        ...
        * @return Returns a NautilusStatus status code
        */ 
        virtual NautilusStatus setShellCamera(const NautilusCameraMode& _mode);
         ...
         * @return Returns a NautilusStatus status code
         */
        NautilusStatus setShellDimension(const NautilusDimension& _dim);
         ...
         * @return Returns a NautilusStatus status code
         */ 
        NautilusStatus setShellViewport(const NautilusViewport& _viewport);
         ...
         * @return Returns a NautilusStatus status code
         */ 
        virtual NautilusStatus updateShellViewport(const NautilusViewport& _viewport) = 0;
         ...
         * @return Returns a NautilusStatus status code
         */
        NautilusStatus attach(NautilusPipeline* _pipe); 
         ...
         * @return Returns a NautilusStatus status code
         */ 
        NautilusStatus setShellRefreshRate(uint32_t _fps);
         ...
         * @return Returns a NautilusStatus status code
         */
        NautilusStatus setShellDecoration(bool _decoration = true); 
         ...
         * @return Returns a NautilusStatus status code
         */ 
        NautilusStatus waitUntilAttachedToCore(void);
         ...
         * @return Returns a NautilusStatus status code
         */ 
        NautilusStatus activate(const std::string& _identifier);
    ...
    protected:
         ...
         * @return Returns a NautilusStatus status code
         */  
        NautilusStatus printStats(void);

        /**
         * Sets the global default window hints
         * @return Returns a NautilusStatus status code
         */  
        NautilusStatus setDefaultWindowHints(void);

        /**
         * Sets API specific window hints
         * @return Returns a NautilusStatus status code
         */ 
        virtual NautilusStatus setAPIWindowHints(void) = 0;
