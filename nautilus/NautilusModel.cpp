...
namespace nautilus {
    ...
    NautilusStatus NautilusModel::bind(NautilusPipeline _pipe) {
        return NAUTILUS_STATUS_OK;
    }

    NautilusStatus NautilusModel::load(const std::string& _path) {
        Assimp::Importer imp;
        ...
        if(!scene || scene->mFlags & AI_SCENE_FLAGS_INCOMPLETE || !scene->mRootNode) {
            ...
            logger::log("ASSIMP Importer error: " + err);
    ...
    NautilusStatus NautilusModel::node(aiNode* _node, const aiScene* _scene) {
