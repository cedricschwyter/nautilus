...
NautilusStatus NautilusVulkanBuffer::bind() {
...
template< typename T >
NautilusStatus NautilusVulkanBuffer::fill(const T& _data, const bool _staging) {
    return NAUTILUS_STATUS_OK;
}

template< typename T >
NautilusStatus NautilusVulkanBuffer::fill(T&& _data, const bool _staging) {
    return NAUTILUS_STATUS_OK;
}

NautilusStatus NautilusVulkanBuffer::fill(const void* _data, const bool _staging) {
    if(!_staging) {
        void* data;
        vkMapMemory(
            this->m_core.m_logicalDevice,
