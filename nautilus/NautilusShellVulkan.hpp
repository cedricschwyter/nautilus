...
namespace nautilus {
    ...
    protected:
        ...
        VkSampleCountFlagBits                   m_maxVulkanMSAASampleCount                  = VK_SAMPLE_COUNT_1_BIT;
    ...
    private:
         ...
         */ 
        NautilusQueueFamilyVulkan findSuitableQueueFamily(VkPhysicalDevice _device);
         ...
         */ 
        NautilusSwapchainDetailsVulkan querySwapchainDetails(VkPhysicalDevice _device);
